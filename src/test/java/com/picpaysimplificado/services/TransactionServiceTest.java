...
class TransactionServiceTest {
	...
	void createTransactionCase1() throws Exception {
		...
		User receiver = new User(2L, "Joao", "Silva", "99999999902", "joao@gmail.com", "123456", new BigDecimal(10), UserType.COMMON);
		...
		TransactionDTO request = new TransactionDTO(new BigDecimal(5), 1L, 2L);
